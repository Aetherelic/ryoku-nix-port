...
Item {
    ...
    Row {
        ...
        Row {
            ...
            UiText { anchors.verticalCenter: parent.verticalCenter; text: I18n.tr("STATE SYNCED"); color: hdr.root.sumi; font.family: hdr.root.mono; font.pixelSize: 10; font.letterSpacing: 1 }
        }
        UiText {
            anchors.verticalCenter: parent.verticalCenter
