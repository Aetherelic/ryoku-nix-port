    ...
    Column {
        ...
        Repeater {
            ...
            delegate: Rectangle {
                ...
                height: 40 * root.s
                radius: Theme.radius
                color: prow.sel ? Qt.alpha(Theme.brand, 0.16) : (pHov.hovered ? Theme.frameBg : "transparent")
                border.width: 1
                border.color: prow.sel ? Theme.brand : (pHov.hovered ? Theme.frameBorder : Theme.border)
                ...
                Pill.MaterialIcon {
                    ...
                    fill: prow.sel ? 1 : 0
                    color: prow.sel ? Theme.brand : Theme.iconDim
                ...
                Text {
                    ...
                    color: prow.sel ? Theme.brand : Theme.cream
                    font.family: Theme.font
